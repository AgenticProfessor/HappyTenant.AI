...
/**
 * Xero Export Implementation
 * 
 * Generates a CSV formatted for Xero import.
 * Xero typically expects: Date,Amount,Payee,Description,Reference,Check Number
 */
...
export async function POST(request: Request) {
    try {
        ...
        return NextResponse.json(
            { error: 'Failed to export to Xero' },
            { status: 500 }
        );
    }
}
